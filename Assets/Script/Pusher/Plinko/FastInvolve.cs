...
public class FastInvolve : MonoBehaviour
{
[UnityEngine.Serialization.FormerlySerializedAs("ShootPoint")]
    public GameObject FinchTrace;
[UnityEngine.Serialization.FormerlySerializedAs("ballPerfab")]    public GameObject HalfViewer;
    ...
    //    rotateSeq.Play();
    //}
    public void AffixFast()
    {
        float scale = 0.2f;
        GameObject ball = Instantiate(HalfViewer, transform);
        ball.transform.position = FinchTrace.transform.position;
