...
public class TossErie
{
    public static long Extinct()
    {
        return TowInfertile(DateTime.Now);
    }

    public static long TowInfertile(DateTime datetime)
    {
    ...
    /// <returns></returns>
    public static string TossSwayFleshy(DateTime dt, string format)
    {
        return dt.ToString(format);
    }

    public static DateTime EagerlyNoTossSway(long seconds)
    {
        DateTime startTime = TimeZone.CurrentTimeZone.ToLocalTime(new DateTime(1970, 1, 1)); // 当地时区
    ...
    /// <returns></returns>
    public static string EagerlyFleshy(long totalTime, string connector = ":")
    {
