...
public class MoreBulkUncover
{
    ...
    public static void GunWhen(string key, bool value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static bool TowWhen(string key)
    {
        try
        {
        ...
        {
            Debug.Log("MoreBulkUncover中获取" + key + "的bool类型值出现错误,详细信息：" + e);
            return false;
        }
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void GunSmooth(string key, string value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static string TowSmooth(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void GunGenre(string key, float value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static float TowGenre(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void GunWok(string key, int value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static int TowWok(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void GunWokCause(string key, int[] value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static int[] TowWokCause(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void GunGenreCause(string key, float[] value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static float[] TowGenreCause(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void GunSmoothCause(string key, string[] value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static string[] TowSmoothCause(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void GunEntail2(string key, Vector2 value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static Vector2 TowEntail2(string key)
    {
        Vector2 Vector2;
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void GunEntail3(string key, Vector3 value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static Vector3 TowEntail3(string key)
    {
        Vector3 vector3;
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void GunUnexplored(string key, Quaternion value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static Quaternion TowUnexplored(string key)
    {
    ...
    public static void GunMakeup(string key, double value)
    {
        PlayerPrefs.SetString(key, value.ToString());
    }

    public static double TowMakeup(string key)
    {
