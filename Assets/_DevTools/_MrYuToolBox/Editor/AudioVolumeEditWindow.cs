...
public class AudioVolumeEditWindow : EditorWindow
{
    ...
    Dictionary<string, ChinaBring> UIAudioGroup;
    Dictionary<string, ChinaBring> SceneAudioGroup;
    //序列化对象
    ...
    {
        UIAudioGroup = new Dictionary<string, ChinaBring>();
        SceneAudioGroup = new Dictionary<string, ChinaBring>();
        ...
        Dictionary<string, ChinaBring> audioDic = new Dictionary<string, ChinaBring>();
        if (FileInfo.Exists)
        {
        ...
        //UI
        foreach(object music in Enum.GetValues(typeof(BrownOnce.UIMusic)))
        {
            string name = music.ToString();
            if (name == "None") continue;
            ChinaBring model = new ChinaBring();
        ...
        // Scene
        foreach (object music in Enum.GetValues(typeof(BrownOnce.SceneMusic)))
        {
            string name = music.ToString();
            if (name == "None") continue;
            ChinaBring model = new ChinaBring();
    ...
    public Dictionary<string, ChinaBring> LoadJson(string Filepath)
    {
        StreamReader reader = new StreamReader(Filepath);
        string jsonString = reader.ReadToEnd();
        Dictionary<string, ChinaBring> audioGroup = JsonMapper.ToObject<Dictionary<string, ChinaBring>>(jsonString);
        reader.Dispose();
        reader.Close();
        return audioGroup;
    }
    ...
    {
        Dictionary<string, ChinaBring> dic = new Dictionary<string, ChinaBring>();
        MergeDictionaries.Swear(dic, UIAudioGroup);
        MergeDictionaries.Swear(dic, SceneAudioGroup);
